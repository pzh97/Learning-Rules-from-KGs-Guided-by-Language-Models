...
import de.mpii.embedding.BertClient;
import de.mpii.embedding.HyperContxClient;
import de.mpii.embedding.HyperDirClient;
import de.mpii.embedding.HyConQuyClient;
...
public class Miner implements Runnable {
    ...
    public Miner(String workspace, MinerConfig config, PrintWriter output) {
        if (config.embeddingWeight != 0) {
            ...
            } else if (config.embeddingModel.equalsIgnoreCase("bert")) {
		        embeddingClient = new BertClient(workspace);
	        } else if (config.embeddingModel.equalsIgnoreCase("hypercontx")) {
                embeddingClient = new HyperContxClient(workspace);
	        } else if (config.embeddingModel.equalsIgnoreCase("hyperdir")) {
                embeddingClient = new HyperDirClient(workspace);
            } else if (config.embeddingModel.equalsIgnoreCase("hyconquy")) {
                embeddingClient = new HyConQuyClient(workspace);
            } else {
